...
public static class PlanetDefs
{
    ...
    public static readonly PlanetDef DebugWorld = new("debug", "Debug",
        ...
        // 0.49 is BELOW the campaign generator's 0.65 floor, which the old 0.55 experiment
        // showed is unsafe for a world with a lava SEA (it leaked into the dry strata:
        // ~75k cells churning forever). The rig carries LavaFillFrac 0f — no sea to leak —
    ...
    public static readonly PlanetDef[] Classic =
    {
        ...
        new("frost", "Frost", "Frozen wastes, deep water, sapphire seams",
            ...
            OreBias: new[] { (TileKind.Sapphire, 0.030f), (TileKind.SilverOre, 0.055f), (TileKind.Emerald, 0.015f) },
        ...
        new("slag", "Slag", "Dead metal world, platinum veins, restless crust",
            ...
            OreBias: new[] { (TileKind.PlatinumOre, 0.030f), (TileKind.GoldOre, 0.05f), (TileKind.IronOre, 0.025f) },
            QuakeScale: 0.45f, CaveSpawnCap: 20,
